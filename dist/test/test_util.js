...
describe('TestUtils', function() {
  ...
  it('should support hasTags', function() {
    ...
    _chai.assert.isTrue(_test_util2.default.hasTags(span, tags));
    _chai.assert.isFalse(_test_util2.default.hasTags(span, { k: 'v' }));
    _chai.assert.isFalse(_test_util2.default.hasTags(span, { keyOne: 'valueTwo' }));
  });
