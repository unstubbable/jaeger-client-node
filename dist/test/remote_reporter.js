...
describe('Remote Reporter', function() {
  ...
  it('should report span, and flush', function(done) {
    ...
    reporter.flush(function() {
      ...
      _chai.assert.isTrue(_backend2.default.counterEquals(metrics.reporterSuccess, 1));
      done();
    });
  });
  ...
  it('should fail to flush spans with bad sender', function(done) {
    ...
    reporter.flush(function() {
      ...
      _chai.assert.isTrue(_backend2.default.counterEquals(metrics.reporterFailure, 1));
      done();
    });
  });
