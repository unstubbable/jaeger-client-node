...
var LegacySamplerV1Base = (function(_BaseSamplerV) {
  ...
  function LegacySamplerV1Base(name) {
    ...
    return _possibleConstructorReturn(
      this,
      (LegacySamplerV1Base.__proto__ || Object.getPrototypeOf(LegacySamplerV1Base)).call(this, name)
    );
  }
...
var LegacySamplerV1Adapter = (function(_LegacySamplerV1Base) {
  ...
  function LegacySamplerV1Adapter(delegate) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (LegacySamplerV1Adapter.__proto__ || Object.getPrototypeOf(LegacySamplerV1Adapter)).call(
        this,
        delegate.name()
      )
    );
