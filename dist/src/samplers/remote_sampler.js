...
var RemoteControlledSampler = (function() {
  ...
  function RemoteControlledSampler(serviceName) {
    ...
    this._sampler = (0, _adapt_sampler.adaptSamplerOrThrow)(
      options.sampler || new _probabilistic_sampler2.default(DEFAULT_INITIAL_SAMPLING_RATE)
    );
  ...
  _createClass(RemoteControlledSampler, [
    ...
    },
    {
      ...
      value: function _refreshSamplingStrategy() {
        ...
        _util2.default.httpGet(
          this._host,
          this._port,
          this._samplingPath + '?service=' + serviceName,
          success,
          error
        );
      },
