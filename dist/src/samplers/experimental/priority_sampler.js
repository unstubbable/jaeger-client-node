 ...
 */
var PrioritySamplerState = (exports.PrioritySamplerState = function PrioritySamplerState(
  numDelegateSamplers
) {
...
var PrioritySampler = (function(_BaseSamplerV) {
  ...
  function PrioritySampler(samplers) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (PrioritySampler.__proto__ || Object.getPrototypeOf(PrioritySampler)).call(this, 'PrioritySampler')
    );
