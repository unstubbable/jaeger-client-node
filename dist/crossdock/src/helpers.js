...
var Helpers = (function() {
  function Helpers(tracer) {
    ...
    var crossdockSpec = _fs2.default.readFileSync(
      _path2.default.join(
        __dirname,
        '..',
        '..',
      ...
      },
      {
        ...
        value: function callDownstreamHTTP(downstream, serverSpan) {
          ...
          return new _rsvp2.default.Promise(function(resolve, reject) {
            ...
            _this2._tracer.inject(clientSpan.context(), opentracing.FORMAT_HTTP_HEADERS, headers);
      ...
      },
      {
        ...
        value: function callDownstreamTChannel(downstream, serverSpan) {
          ...
          return new _rsvp2.default.Promise(function(resolve, reject) {
            ...
            request.send('TracedService::joinTrace', null, { request: joinTraceRequest }, function(
              err,
              response
            ) {
              if (err) {
