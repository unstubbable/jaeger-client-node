...
var TChannelServer = (function() {
  function TChannelServer() {
    var crossdockSpecPath =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_THRIFT_PATH;
  ...
  _createClass(TChannelServer, [
    {
      ...
      value: function handleTChannelRequest(perProcessOptions, req, head, body, callback) {
        ...
        _helpers2.default.log(
          'TChannel',
          traceRequest.serverRole,
          'received joinTrace request',
          _helpers2.default.json2str(traceRequest)
        );
